...
<div class="page">
                                ...
                                <form id="quote_form_1">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                                ...
                                                                <div class="example-wrap margin-vertical-20 text-center ">
                                                                        <h4 class="example-title text-center">Select Your Projects</h4>
																																	<p>
																																		A full project includes everything associated with renovating the selection. For example a bathroom project will have the flooring, painting and fixtures and painting interior will have everything you need to price the interior of a home.
																																	</p>
                                                                        <div class="row text-center">
                                                                                <?php
                                                                                $by_project_cnt = 0;
                                                                                $by_project_args = array('post_type'=>'template', 'posts_per_page'=>-1, 'meta_key'=>'by_type','meta_value'=>'by_project');
                                        ...
                                        if($tooltip != '') {
                                             ...
                                             $tooltit_text = '';
                                                                                        ...
                                                                                        <label class="styled " <?php echo $tooltit_text; ?>>
	 ...
	 <?php if(is_agent || is_headcontractor() ) : ?>
                                                        ...
                                                        <div class="col-md-12" style="display: none">
                                                                ...
                                                                <div class="example-wrap margin-vertical-20 text-center ">
                                                                        <h4 class="example-title text-center">Select Advanced Quotes</h4>
																																	<p>
																																		An advanced quote is a highly detailed way to find an exact price for a your project.
																																	</p>
                                                                        <div class="row text-center">
                                                                                <?php
                                                                                $by_service_cnt = 0;
