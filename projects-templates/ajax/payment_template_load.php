...
$template_id = $_POST['load_template_id'];
$template_data = get_field('payment_template',$template_id);
                                                                      ...
                                                                      <div class='row'>
                                                                              <div class='col-md-12 col-xs-12'>
                                                                                      ...
                                                                                      <div class='form-group'>
                                                                                              <input type='text' class='form-control input-sm titles' name='title[]' value='" . $data['title'] . "'>
                                                                                      </div>
                                                                              </div>
                                                                      </div>
                                                                      <div class='row'>
                                                                              <div class='col-md-12 col-xs-12'>
                                                                                      ...
                                                                                      <div class='form-group'>
                                                                                              <textarea type='text' class='form-control input-sm quote_textarea' name='description[]'>" . $data['description'] . "</textarea>
                                                                                      </div>
                                                                              </div>
                                                                      </div>
                                                                      <div class='row'>  
                                                                              <div class='col-md-6 col-xs-12'>
                                                                                      ...
                                                                                      <div class='form-group'>
                                                                                              <input type='number' min='1' max='100' step='1' class='form-control input-sm percents' name='percent[]' value='" . $data['percent'] . "'>
                                                                                      </div>
                                                                              </div>
                                                                              <div class='col-md-6 col-xs-12'>
