...
<?php
if(is_page('all_projects') || is_page('all_contacts') || is_singular('project') || is_page('payments')) { $body_class = 'app-work'; }
elseif(is_page('account') || is_page_template('agent-profile-template.php')) { $body_class = 'page-profile'; }
...
<div class="navbar-container container-fluid">
        ...
        <!-- Navbar Collapse -->
                ...
                <ul class="nav navbar-toolbar">
               	<li>
	<form action="<?php bloginfo('url'); ?>/add_quote">
		<button class="btn btn-primary bg-cyan-500 btn-raised navbar-btn btn-sm" href="">GET STARTED</button>
	</form>
	 </li>
	...
	<li>
			...
			<button class="btn btn-default bg-white btn-raised navbar-btn btn-sm" href="">LOGIN</button>
		</form>
	</li>
					<?php endif ; ?>		
