		...
		<div class="page-content bg-white">
					...
					*/ ?>
					<?php // Completed by Client (show only when projectStatus == live) ?>
						<?php if($projectStatus->status == 'live' || $projectStatus->status == 'quote' || $projectStatus->status == 'pending') : ?>
					<div class="row margin-bottom-40 text-center">
						<div class="col-md-12">
							<div class="margin-bottom-20 font-size-18" style="color:#37474f;">Outcome</div>
							<div id="projectCompletingResponse"></div>
							<div id="projectCancelResponse"></div>
							<a class="btn btn-lg btn-success margin-horizontal-5 projectComplete" data-project='<?php echo $projectId; ?>' data-user='<?php echo $currentUserId; ?>'>Won</a>
							<a class="btn btn-lg btn-danger margin-horizontal-5 projectCancel" data-project='<?php echo $projectId; ?>' data-user='<?php echo $currentUserId; ?>'>Lost</a>
						</div>
					</div>
					<?php endif; ?>
					<?php /*
         ...
         <div class="panel panel-bordered">
            <div class="padding-20 bg-grey-100">
					...
					<div class="col-md-4">
						<div class="relative font-size-30 inline-block">
								...
								<div class="frontEndManage">
										<a class="btn btn-xs btn-outline btn-round btn-default btn-icon" data-toggle="modal" data-target="#manageStatus"><i class="white icon wb-pencil"></i></a>
									</div>
								</div>
						</div>	
				 <div class="pull-right">
					...
					<?php endif; ?>
					 							 <a target="_blank" class="inline-block btn-danger btn btn-lg btn-outline" href="<?php bloginfo('url'); ?>/tcpdf/scope/scope.php?project_id=<?php echo get_the_ID(); ?>" >View PDF</a>
            ...
            <div class="panel-heading">
							...
							<div class="font-size-30 blue-grey-700 inline-block updateTitle"><?php the_title(); ?>
										<a class="btn btn-xs btn-round btn-default btn-icon" data-toggle="modal" data-target="#manageTitle"><i class="icon white wb-pencil"></i></a>
									</div><br/>
								<div class="font-size-20 inline-block blue-grey-500">
									<i class="icon wb-time"></i>&nbsp;&nbsp;<span class="updateTimeframe"><?php echo $projectTimeframe; ?></span>
										<a class="btn btn-xs btn-round btn-default btn-icon" data-toggle="modal" data-target="#manageTimeframe"><i class="icon white wb-pencil"></i></a>
								</div><br/>
								<br/>
					...
					<div class="col-md-4">
                        ...
                        <div class="col-md-12">
                                <div class="widget widget-shadow">
								    ...
								    <a class="btn btn-xs btn-outline btn-round btn-default btn-icon" data-toggle="modal" data-target="#manageClient"><i class="icon white wb-pencil margin-horizontal-0"></i></a>
								</div>
...
foreach($projectScope as $pS) {
	...
	$message .= '<div class="font-size-20 red-800">Sub Total: $' . $scopePrice . '</div>';
...
<div class="row">
		 ...
		 <div class="panel-heading bg-grey-100">
				 ...
				 <div class="pull-right">
					...
					<?php if($clientApprove != true && $projectStatus->status == 'quote' || $projectStatus->status == 'pending') : ?>
							...
							<a class="btn btn-lg btn-success margin-horizontal-5 projectAccept" data-project='<?php echo $projectId; ?>' data-user='<?php echo $currentUserId; ?>'>Accept</a>
		...
		<div class="col-md-6">
				<div class="panel-heading">
				        <div class="font-size-20 blue-grey-700 hidden-sm">PEOPLE</div>
              		<div class="panel-actions">
											<a class="margin-horizontal-10 btn btn-sm btn-outline btn-default" data-toggle="modal" data-target="#addAgent">Add Qwoter</a>
              		</div>
            	</div>
					<div class="row">
...
<div class="row">
                                ...
                                <div class="widget widget-shadow">
                                        <div class="widget-header white bg-blue-600 padding-30 clearfix">
																									<span class="label label-white">Job Manager</span>
                                                <a class="avatar avatar-100 pull-left img-bordered margin-right-20" href="javascript:void(0)">
                                                ...
                                                <div class="pull-left relative">
                                                      <div class="font-size-20 margin-bottom-15 newNames"><?php echo $agentData->first_name; ?>&nbsp;<?php echo $agentData->last_name; ?></div>
																										<div class="frontEndManage" style="top:15px; right:10px;">
											                                                <a class="btn btn-xs btn-outline btn-round btn-default btn-icon removeAgentMiddleware" data-agent="<?php echo $agentId; ?>" data-names="<?php echo $agentData->first_name; ?> <?php echo $agentData->last_name; ?>" data-toggle="modal" data-target="#removeAgent"><i class="icon wb-close-mini margin-horizontal-0"></i></a>
																							<br />
																							<?php if($agentLead == true) : ?>
																								<a style="cursor:default;" class="btn btn-xs btn-outline btn-round btn-default btn-icon margin-top-5 agent_<?php echo $agentId; ?> alreadyLead" data-agent="<?php echo $agentId; ?>" data-project="<?php echo $projectId; ?>"><i class="icon wb-star yellow-600 margin-horizontal-0"></i></a>
											                                                <?php else : ?>
											                                                    <a class="btn btn-xs btn-outline btn-round btn-default btn-icon margin-top-5 agent_<?php echo $agentId; ?> makeLead" data-agent="<?php echo $agentId; ?>" data-project="<?php echo $projectId; ?>"><i class="icon wb-star-outline margin-horizontal-0"></i></a>
											                                                <?php endif; ?>
                          ...
                          <div class="col-md-12">
                                <div class="widget widget-shadow">
                                        <div class="widget-header white bg-green-600 padding-30 clearfix">
																													<span class="label label-white">Painter</span>
                                                <a class="avatar avatar-100 pull-left img-bordered margin-right-20" href="javascript:void(0)">
                                                ...
                                                <div class="pull-left relative">
                                                      <div class="font-size-20 margin-bottom-15 newNames"><?php echo $contractorData->first_name; ?>&nbsp;<?php echo $contractorData->last_name; ?></div>
																									<div class="frontEndManage" style="top:15px; right:10px;">
                                    <?php if(in_array($contractorData->id,$currentUserContactsArray)) : ?>
       ...
       <div class="col-md-6">
			...
			<div class="panel">
				<div class="panel-heading">
              		...
              		<div class="panel-actions">
						<a class="panel-action margin-horizontal-10 btn btn-sm btn-outline btn-default managePaymentsTab" onclick="managePaymentsShow(<?php echo $projectId; ?>);">Manage Payments</a>
                        <a class="panel-action margin-horizontal-10 btn btn-sm btn-outline btn-default manageVariationsTab" onclick="manageVariationsShow(<?php echo $projectId; ?>);">Manage Variations</a>
				...
				<div class="col-md-12">
					<?php // project Schedule ?>
						...
						<div class="panel-heading">
		              		...
		              		<div class="panel-actions">
								<a class="panel-action margin-horizontal-10 btn btn-sm btn-outline btn-default manageSchedules" onclick="manageSchedulesShow(<?php echo $projectId; ?>);">Manage Schedules</a>
		                		<a class="panel-action icon wb-minus" data-toggle="panel-collapse" aria-hidden="true"></a>
		              		</div>
		            	</div>
						<div class="panel-body">
