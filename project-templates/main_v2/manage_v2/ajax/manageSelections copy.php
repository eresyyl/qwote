                ...
                if($tD['title'] == $scopeSectionTitle) {
                  foreach($tD['fields'] as $field) {
                    ...
                    if($field['title'] == $cleanValue && $field['selections_category'] != null) {
                        ...
                        $message .= '<div class="margin-top-40">';
                        ...
                        $message .= '<div class="margin-horizontal-20 margin-top-20 padding-5 selectionsRow-' . $radioName . '"><ul class="blocks blocks-100 blocks-xlg-6 blocks-md-5 blocks-sm-3" id="exampleList">';
