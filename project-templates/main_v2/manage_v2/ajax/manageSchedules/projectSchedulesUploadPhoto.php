...
if (isset($_FILES) ) {
	...
	if ( $movefile && !isset( $movefile['error'] ) ) {
		...
		require_once( ABSPATH . 'wp-admin/includes/image.php' );
                ...
                echo "<div class='uploaded_image_section schedulePhotoUploaded'>";
                        echo "<input type='hidden' name='schedulePhoto_" . $row . "[]' class='attachment' value='" . $attach_id . "'>";
