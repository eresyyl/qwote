...
if($_POST && $_POST['templateId']) {
    ...
    $projectSchedules = get_field('schedule_template',$templateId);
    ...
    if($projectSchedules) : $i=0; foreach($projectSchedules as $pay) : $i++;
        $title = $pay['title'];
                      ...
                      <div class="row allTasksRow margin-bottom-40">
                              <div class="col-md-12 col-xs-12">
                                      ...
                                      <div class="text-right">
                                            <a class="btn btn-sm btn-outline btn-default addScheduleTask" data-id="'.$i.'">Add Task</a>
                                      </div>
                              </div>
                      </div>
                      <div class="row">
