...
<div class="page animsition">
	...
	<div class="page-main"> 
		<div class="page-content">
                        <div class="row">
                                <div class="col-md-8">
                                        <h3><?php echo go_generate_title($quote_id); ?></h3>
																	<p>
                                        ...
                                        <div class="row">
                                                             ...
                                                             <div class="widget-header padding-10 bg-grey-100">
                                                                     ...
                                                                     <div class="vertical-align text-right height-80 text-truncate">
                                                                             <div class="vertical-align-middle">
                                                                                     <div class="font-size-16 margin-bottom-5 blue-600 text-truncate"><?php echo $client->first_name; ?> <?php echo $client->last_name; ?><br/><?php echo $client->phone; ?></div>
                                             ...
                                             <div class="col-md-6">
                                                 <div class="widget widget-shadow margin-bottom-10">
                                                     ...
                                                     if($agent_approved != true && $status->status == 'pending') :
                                                     ?>
    	...
    	<div class="row">
			...
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title" style="font-size:18px; padding: 0px 10px;">Updates</h3>
				</div>
				<div class="panel-body">
			...
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title" style="font-size:18px; padding: 0px 10px;">Project Panel</h3>
				</div>
				<div class="panel-body">
                                                ...
                                                <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
                                                        ...
                                                        <li class="dropdown" role="presentation" style="display: none;">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                        ...
                                                                        <li class="" role="presentation"><a data-toggle="tab" href="#activity" aria-controls="activity" role="tab">Notifications</a></li>
                                                                ...
                                                                <td class="actions text-center">
                                                                        <div class="table-content">
                                                                                ...
                                                                                if($payment['status'] == 'active') {
                                                                                        go_payment_actions(array('mark_done'),$quote_id,$i);
                                                                                }
                                                                                elseif($payment['status'] == 'done') {
