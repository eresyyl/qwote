...
<div class="row text-center">
       ...
       <figure
            ...
            <?php if($agentToken) : ?>data-token="<?php echo $agentToken; ?>"<?php else : ?>data-token="0"<?php endif; ?>>
                    ...
                    <figcaption class="margin-top-10">
                      <div class="font-size-30 margin-bottom-30 blue-grey-800"><?php echo $template->post_title; ?></div>
                    </figcaption>
                  </figure>
    ...
    <!-- End Modal -->
			...
			<!-- Modal -->
    <div class="modal fade" id="contact" aria-hidden="true" aria-labelledby="contact"
    role="dialog" tabindex="-1">
      <div class="modal-dialog modal-center">
        <div class="modal-content">
          <div class="modal-header">
