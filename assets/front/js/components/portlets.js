...
$.components.register("portlets", {
  ...
  init: function(context) {
    ...
    $('[data-plugin="portlets"]', context).each(function() {
      var $container = $(this),
        item = $container.data('item') ? $container.data('item') : defaults.item,
        packeryOptions = $.extend(true, {}, defaults.packery, $container.data('packery')),
        draggabillyOptions = $.extend(true, {}, defaults.draggabilly, $container.data('draggabilly'));
